...
const add = (event) => {
	...
	cont.innerHTML += `<div class="card"><div class="row"><div class="col-xs-3"><a href="#profile" title="Profile"><img src="static/img/grumpy.jpg" class="img-circle img-user" alt="User"></a></div><div class="col-xs-9"><div class="comment"><h5><a href="#profile" title="Profile">Grumpy:</a></h5><p>${comment}</p><div><i class="fas fa-heart"></i></div></div></div></div></div>`
